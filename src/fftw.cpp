...
//Modified by ZhouQ and Gaoxing for randomize phases beyond a a given resolution shell with a given amplitude
void randomizePhasesBeyond(MultidimArray<RFLOAT> &v, int index, int index_upper, RFLOAT amplitude)
{
    MultidimArray< Complex > FT;
    FourierTransformer transformer;
